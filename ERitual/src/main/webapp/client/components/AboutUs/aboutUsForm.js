...
class AboutUsForm extends Component {
    ...
    render() {
      const {userTagConfigFormsRequest,getAboutUsByKeyRequest,editAboutUs} = this.props;
        return (
            <div className="row full-height">
              <div className="col-md-8 col-md-offset-2 full-height">
                <LargeLogo id="large_logo" className="large-logo"/>
                {this.props.editAboutUs &&  this.props.editAboutUs.length != 0 && <AboutUsFormContainer userTagConfigFormsRequest={userTagConfigFormsRequest} editAboutUs={editAboutUs} getAboutUsByKeyRequest={getAboutUsByKeyRequest}/>} 
              </div>
            </div>
        );
    }
...
export default connect(mapStateToProps, {userTagConfigFormsRequest,addToast,getAboutUsByKeyRequest} )(AboutUsForm)
