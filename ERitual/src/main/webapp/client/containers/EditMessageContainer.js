...
class EditMessageContainer extends Component {
	...
	{
		if(this.state.name !=""){
			this.state.imageDescription = this.state.name + "_Picture";
			this.state.tags= this.state.name + "," + this.state.templeName;
		}
		let imageValue = {
	...
	render() {
		...
		return (
				...
				<div className="col-xs-12">
				{/*
				 * <TextFieldGroup onChange={this.onImageUpload}
				 * value={image} field="image" type="file"
